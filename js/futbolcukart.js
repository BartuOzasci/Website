// script.js (Tüm kartlarda sabit resim kullanacak şekilde güncellendi)
...
async function dealCards() {
    try {
        ...
        if (!response.ok) {
            throw new Error('kartfutbolcu.txt dosyası bulunamadı! Klasörde olduğundan emin misiniz?');
        }
        ...
        // ================== DEĞİŞİKLİK BURADA ==================
        // Artık tüm kartlar için bu sabit resim yolu kullanılacak.
        // Resminizin adının 'kart-sablonu.png' olduğundan emin olun.
